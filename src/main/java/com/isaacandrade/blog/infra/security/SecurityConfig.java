    ...
    public SecurityFilterChain securityFilterChain(HttpSecurity httpSecurity) throws Exception {
        return httpSecurity
                ...
                .authorizeHttpRequests(auth -> auth
                        ...
                        .requestMatchers(HttpMethod.PUT, "/technologies/**").hasRole("ADMIN")
                        .requestMatchers(HttpMethod.DELETE, "technologies/**").hasRole("ADMIN")
                        .requestMatchers(HttpMethod.GET, "/about/**").permitAll()
                        .requestMatchers(HttpMethod.POST, "/about/**").hasRole("ADMIN")
                        .requestMatchers(HttpMethod.PUT, "/about/**").hasRole("ADMIN")
                        .requestMatchers(HttpMethod.DELETE, "/about/**").hasRole("ADMIN")
